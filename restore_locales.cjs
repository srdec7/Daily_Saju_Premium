...
const data = {
  ko: {
    actions: [
      ...
      { a: '따뜻한 햇살을 10초라도 직접 마주하며 심호흡하세요.', r: '불(화)의 양기가 침체된 오라를 바깥으로 발산시켜 줍니다.' },
  ...
  en: {
    actions: [
      ...
      { a: 'Face the literal sun and take a deep breath for 10 seconds.', r: 'The Yang energy of Fire expands your stagnant aura outward.' },
  ...
  ja: {
    actions: [
      { a: '近くの公園や木のある場所を5分間散歩してください。', r: '木（もく）の青々とした気が、疲れた目と脳を澄み切らせます。' },
      { a: '10秒だけでも暖かい日差しを直接浴びて深呼吸してください。', r: '火（か）の陽気が、停滞したオーラを外へと発散させてくれます。' },
      { a: '裸足で土を踏むか、しばらく床にゆったり座ってみてください。', r: '土（ど）のどっしりとしたエネルギーが、浮ついた心の根を下ろしてくれます。' },
      { a: '机や財布に入っている不要なレシートを1枚捨ててください。', r: '金（ごん）の決断力が必要な日です。小さな手放しが金運を開きます。' },
      { a: '普段よりゆっくりと、コップ一杯の水を味わいながら飲んでください。', r: '水（すい）の柔軟さが摩擦を減らす潤滑油になります。無理しないでください。' }
    ],
    tiles: [
...
langs.forEach(l => { if(!data[l]) data[l] = data['en']; });
